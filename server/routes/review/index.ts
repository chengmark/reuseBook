...
export class ReviewRoutes extends Routes {
  ...
  configureRoutes(): void {
    ...
    this.router.route('/books/:bookId/reviews/:reviewId/edit').post((req: Request, res: Response) => {
    ...
    this.router.route('/books/:bookId/reviews/:reviewId/user').get((req: Request, res: Response) => {
